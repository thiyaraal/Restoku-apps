...
class CategoriesModalContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasFoods =
        provider.detail?.restaurant?.menus?.foods?.isNotEmpty ?? false;
    final hasDrinks =
        provider.detail?.restaurant?.menus?.drinks?.isNotEmpty ?? false;
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () {
                        provider.setCategory(categories[index]["type"]!);
